    ...
    <ThemeProvider theme={dTheme}>
      <CssBaseline />
        <Routes>
          ...
          <Route path="/history" element={<MainPage page={<GameHistoryList />}/>} />
          <Route path="/people" element={<MainPage page={<DashboardContent />}/>} />
          <Route path="/setting" element={<MainPage page={<ChangeDetails />}/>} />
          <Route path="/add-record" element={<MainPage page={<AddRecordForm />}/>} />
